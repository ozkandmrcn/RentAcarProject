...
public class FileHelperManager implements FileHelperService{
	...
	public  void createCarImagePathName(CreateCarImagesRequest createCarImagesRequest,String imagePathName) throws IOException {
		File myFile = new File("C:\\Users\\ozkan.demircan\\EtiyaKamp\\ReCapProject\\images\\" + imagePathName + "." + createCarImagesRequest.getFile().getContentType().toString().substring(6));
	...
	public void updateCarImagePathName(UpdateCarImagesRequest updateCarImagesRequest, String imagePathName)
		...
		File myFile = new File("C:\\Users\\ozkan.demircan\\EtiyaKamp\\ReCapProject\\images\\" + imagePathName + "." + updateCarImagesRequest.getFile().getContentType().toString().substring(6));
		myFile.createNewFile();
		FileOutputStream fileOutputStream = new FileOutputStream(myFile);
